...
- Release signing keystore (only when a Signed release APK / Play Store AAB is chosen in Phase 1 Q9 — see `@rules/config.md §Installation methods`): local, gitignored (`android/key.properties`, `*.jks`).
